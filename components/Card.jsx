  ...
  return (
    <div id="card-div">
      <div className="bg-[#FFFFFF] rounded-[10px] p-4 relative">
        ...
        <h2 className="absolute bottom-5 right-5 text-[.53em] font-bold bg-[#E9F9EB] p-1 text-[#4AD15F] rounded-[12px]">
          + 2.5%
        </h2>
      </div>
      <div className="bg-[#FFFFFF] rounded-[10px] p-4 relative">
        ...
        <h2 className="absolute bottom-6 right-5 text-[.53em] font-bold bg-[#E9F9EB] p-1 text-[#4AD15F] rounded-[12px]">
          + 1.7%
        </h2>
      </div>
      <div className="bg-[#FFFFFF] rounded-[10px] p-4 relative">
