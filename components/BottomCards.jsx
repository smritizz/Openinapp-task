...
const BottomCards = () => {
  ...
  const handleNext = () => {
    if (!name || !email || !phone) {
      alert('Please fill out all required fields.'); // You can use another way to display an error message
      return;
    }
    //next
        ...
        >
          ...
          <div className="h-[377px] ">
            <div
              ...
              id="ModalPRO"
              className="flex justify-between border-b-blue mx-auto w-[480px]"
            >
              <h2
                id="basic"
                className="border-b-4 border-b-[#3F84F8] w-1/2 text-center font-semibold "
              >
                Basic
              </h2>
              <h2
                id="social"
                className="border-b-4 border-b-gray w-1/2 text-center font-semibold "
              >
                Social
              </h2>
            </div>
            {social && (
              <div className="flex flex-col justify-between p-8">
                <div className="flex flex-col mb-3">
                  <label className="font-semibold" htmlFor="Name">Enter Name *</label>
                  <input
                    type="text"
                    id="Name"
                    value={name}
                ...
                <div className="flex flex-col mb-3">
                  <label className="font-semibold" htmlFor="Phone">Enter Phone *</label>
                  <input
                    type="number"
                    id="Phone"
                    value={phone}
            ...
            {basic && (
              <div className="flex flex-col justify-between p-8 ">
                <div className="flex flex-col mb-3">
                  <label className="font-semibold" htmlFor="instaLink">Instagram Link(Optional)</label>
                  <input
                    type="text"
                    id="instaLink"
                    value={instaLink}
                ...
                <div className="flex flex-col mb-3">
                  <label className="font-semibold" htmlFor="ytLink">Youtube Link (Optional)</label>
                  <input
                    type="text"
                    id="ytLink"
                    value={ytLink}
          ...
          <div className="mr-4 h-[88px] flex justify-end">
            <button
              id="back"
              className="p-3 py-1.5 w-[64px] h-[32px] rounded-[8px] mb-20 hidden"
              onClick={handleBack}
            >
              Back
            </button>
            <button
              id="nextBtn"
              className="p-3 py-1.5 bg-[#3E84F8] w-fit-content h-[32px] rounded-[8px] mb-20"
              onClick={handleNext}
            >
              Next
            </button>
            <button
              type="submit"
              id="submitBtn"
              className="p-3 py-1.5 bg-[#3E84F8] w-fit-content h-[32px] rounded-[8px] mb-20 hidden"
              ...
              <div className="flex flex-col">
                <div className="flex justify-between items-center p-2 card-id">
                  <div className="flex justify-start">
                    ...
                    />
                  <a
  href={`https://wa.me/${profilephone}`}
  target="_blank"
  rel="noopener noreferrer"
  style={{ textDecoration: "underline", marginTop: "5px", marginLeft: "7px" }}
>
  {profilephone}
</a>
                  </div>
                  <div className="flex justify-start">
                    ...
                    />
                    {/* <span style={{textDecoration:"underline", marginTop:"5px", marginLeft:"7px"}}>{profileinstaLink}</span> */}
                    <a
                      href={profileinstaLink}
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ textDecoration: "underline", marginTop: "5px", marginLeft: "7px" }}
                    >
